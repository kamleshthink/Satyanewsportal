...
} from "./chunk-RQ3XXUFK.js";
import "./chunk-RAFO2DID.js";
import {
  createSvgIcon,
  ownerDocument,
  useControlled,
...
import "./chunk-3FA4JJAD.js";
import {
  LocalizationProvider,
  MuiPickersAdapterContext
} from "./chunk-YZFCZPKA.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-KARIZOBF.js";
import {
  useThemeProps
} from "./chunk-Q23JXLOK.js";
import {
  alpha,
  capitalize,
  clsx_default,
...
function useValidation(options) {
  ...
  const previousValidationErrorRef = React12.useRef(validator.valueManager.defaultErrorState);
...
var useControlledValue = ({
  ...
  const inputTimezone = React13.useMemo(() => valueManager.getTimezone(utils, valueWithInputTimezone), [utils, valueManager, valueWithInputTimezone]);
  ...
  const valueWithTimezoneToRender = React13.useMemo(() => valueManager.setTimezone(utils, timezoneToRender, valueWithInputTimezone), [valueManager, utils, timezoneToRender, valueWithInputTimezone]);
...
var useFieldState = (parameters) => {
  ...
  const localizedDigits = React14.useMemo(() => getLocalizedDigits(utils), [utils]);
  const sectionsValueBoundaries = React14.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
...
function useApplyDefaultValuesToDateTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React23.useMemo(() => internalProps.ampm ?? utils.is12HourCycleInCurrentLocale(), [internalProps.ampm, utils]);
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime2.jsxs)(React26.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime2.jsxs)(React26.Fragment, {
  children: [(0, import_jsx_runtime2.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime2.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var PickersSectionList = React27.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime3.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime3.jsx)(React27.Fragment, {
...
var PickersOutlinedInput = React31.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime6.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime6.jsxs)(React31.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
var DateTimePickerTabs = function DateTimePickerTabs2(inProps) {
  ...
  return (0, import_jsx_runtime12.jsxs)(DateTimePickerTabsRoot, {
    ...
    children: [(0, import_jsx_runtime12.jsx)(Tab_default, {
      ...
      icon: (0, import_jsx_runtime12.jsx)(React37.Fragment, {
        children: dateIcon
      })
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const utils = useUtils();
  const cleanDate = React42.useMemo(() => !utils.isValid(date) ? null : date, [utils, date]);
  ...
  return (0, import_jsx_runtime16.jsxs)(DateTimePickerToolbarRoot, _extends({
    ...
    children: [(0, import_jsx_runtime16.jsxs)(DateTimePickerToolbarDateContainer, {
      ...
      children: [(0, import_jsx_runtime16.jsxs)(DateTimePickerToolbarTimeDigitsContainer, {
        ...
        ownerState,
        toolbarVariant,
        children: [views.includes("hours") && (0, import_jsx_runtime16.jsxs)(React43.Fragment, {
        ...
        }), views.includes("seconds") && (0, import_jsx_runtime16.jsxs)(React43.Fragment, {
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React46.useRef(createCalendarStateReducer(Boolean(reduceAnimations), utils)).current;
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React51.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React51.useMemo(() => selectedDays.filter((day) => !!day).map((day) => utils.startOfDay(day)), [utils, selectedDays]);
...
var _excluded21 = ["autoFocus", "className", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var MonthCalendar = React53.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const [focusedMonth, setFocusedMonth] = React53.useState(() => selectedMonth || utils.getMonth(referenceDate));
...
var YearCalendar = React55.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const [focusedYear, setFocusedYear] = React55.useState(() => selectedYear || utils.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
...
var PickerPopperPaperWrapper = React61.forwardRef((props, ref) => {
  const {
    PaperComponent,
    ownerState,
    children,
...
function PickerPopper(inProps) {
  ...
  const paperRef = React61.useRef(null);
...
function useOrientation(views, customOrientation) {
  const [orientation, setOrientation] = React62.useState(getOrientation);
  useEnhancedEffect_default(() => {
    const eventHandler = () => {
...
function useValueAndOpenStates(parameters) {
  ...
  } = React63.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React63.useRef(valueProp !== void 0);
  const {
    current: isOpenControlled
  } = React63.useRef(openProp !== void 0);
  const utils = useUtils();
  if (true) {
  ...
  const viewValue = React63.useMemo(() => valueManager.cleanValue(utils, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [utils, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React64.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React64.useState(null);
  const popupRef = React64.useRef(null);
  const fieldRef = React64.useRef(null);
  const rootRefObject = React64.useRef(null);
  ...
  const {
    ...
    viewModeLookup,
    timeViewsCount
  } = React64.useMemo(() => views.reduce((acc, viewForReduce) => {
  ...
  const [popperView, setPopperView] = React64.useState(currentViewMode === "UI" ? view : null);
  ...
  const ownerState = React64.useMemo(() => ({
  ...
  const triggerStatus = React64.useMemo(() => {
  ...
  const contextValue = React64.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React64.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React64.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
var PickersActionBar = React65.memo(PickersActionBarComponent);
...
var usePickerLayout = (props) => {
  ...
  const ownerState = React67.useMemo(() => _extends({}, pickerOwnerState, {
...
var PickersLayout = React68.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime34.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime34.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime34.jsxs)(React68.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime34.jsxs)(React68.Fragment, {
...
var useDesktopPicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime35.jsx)(PickerProvider, _extends({}, providerProps, {
    children: (0, import_jsx_runtime35.jsxs)(PickerFieldUIContextProvider, {
      ...
      slotProps,
      inputRef,
      children: [(0, import_jsx_runtime35.jsx)(Field, _extends({}, fieldProps)), (0, import_jsx_runtime35.jsx)(PickerPopper, {
        slots,
        slotProps,
...
function ClockPointer(inProps) {
  ...
  const previousType = React70.useRef(type);
  React70.useEffect(() => {
...
function Clock(inProps) {
  ...
  const isMoving = React71.useRef(false);
  ...
  return (0, import_jsx_runtime37.jsxs)(ClockRoot, {
    ...
    children: [(0, import_jsx_runtime37.jsxs)(ClockClock, {
      ...
      }), !isSelectedTimeDisabled && (0, import_jsx_runtime37.jsxs)(React71.Fragment, {
    ...
    }), ampm && ampmInClock && (0, import_jsx_runtime37.jsxs)(React71.Fragment, {
...
var TimeClock = React75.forwardRef(function TimeClock2(inProps, ref) {
  const utils = useUtils();
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeClock"
  ...
  const viewProps = React75.useMemo(() => {
    switch (view) {
      case "hours": {
...
var DigitalClock = React76.forwardRef(function DigitalClock2(inProps, ref) {
  const utils = useUtils();
  ...
  const isTimeDisabled = React76.useCallback((valueToCheck) => {
    const isAfter = createIsAfterIgnoreDatePart(disableIgnoringDatePartForTimeValidation, utils);
    const containsValidTime = () => {
  ...
  const timeOptions = React76.useMemo(() => {
    const result = [];
...
var MultiSectionDigitalClockSection = React77.forwardRef(function MultiSectionDigitalClockSection2(inProps, ref) {
  const containerRef = React77.useRef(null);
  const handleRef = useForkRef(ref, containerRef);
  const previousActive = React77.useRef(null);
  const props = useThemeProps({
    props: inProps,
    name: "MuiMultiSectionDigitalClockSection"
  });
...
var MultiSectionDigitalClock = React78.forwardRef(function MultiSectionDigitalClock2(inProps, ref) {
  const utils = useUtils();
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
  ...
  const translations = usePickerTranslations();
  const now = useNow(timezone);
  const timeSteps = React78.useMemo(() => _extends({
    hours: 1,
    minutes: 5,
    seconds: 5
  ...
  const buildViewProps = React78.useCallback((viewToBuild) => {
    switch (viewToBuild) {
      case "hours": {
        return {
          onChange: (hours) => {
  ...
  const viewsToRender = React78.useMemo(() => {
    if (!isRtl) {
      return views;
    }
  ...
  const viewTimeOptions = React78.useMemo(() => {
...
var DesktopDateTimePickerLayout = React80.forwardRef(function DesktopDateTimePickerLayout2(props, ref) {
  var _a;
  const {
    toolbar,
    tabs,
...
var rendererInterceptor = function RendererInterceptor(props) {
  ...
  return (0, import_jsx_runtime46.jsxs)(React81.Fragment, {
    ...
    })), timeViewsCount > 0 && (0, import_jsx_runtime46.jsxs)(React81.Fragment, {
...
var useMobilePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime48.jsx)(PickerProvider, _extends({}, providerProps, {
    children: (0, import_jsx_runtime48.jsxs)(PickerFieldUIContextProvider, {
      slots,
      slotProps,
      inputRef,
      children: [(0, import_jsx_runtime48.jsx)(Field, _extends({}, fieldProps)), (0, import_jsx_runtime48.jsx)(PickersModalDialog, {
        slots,
        slotProps,
...
var MobileDateTimePicker = React84.forwardRef(function MobileDateTimePicker2(inProps, ref) {
...
var DateTimePicker = React85.forwardRef(function DateTimePicker2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
