...
var Grow = React44.forwardRef(function Grow2(props, ref) {
  ...
  return (0, import_jsx_runtime27.jsx)(TransitionComponent, {
    ...
    children: (state, {
      ...
      return React44.cloneElement(children2, {
        style: {
          opacity: 0,
  ...
  return (0, import_jsx_runtime29.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime29.jsx)(InputAdornmentRoot, {
      ...
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime29.jsx)(Typography_default, {
        color: "textSecondary",
        children: children2
      }) : (0, import_jsx_runtime29.jsxs)(React46.Fragment, {
...
var OutlinedInput = React60.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime42.jsxs)(React60.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
...
true ? OutlinedInput.propTypes = {
  ...
  slotProps: import_prop_types51.default.shape({
    ...
    notchedOutline: import_prop_types51.default.oneOfType([import_prop_types51.default.func, import_prop_types51.default.object]),
  ...
  slots: import_prop_types51.default.shape({
    input: import_prop_types51.default.elementType,
    notchedOutline: import_prop_types51.default.elementType,
    root: import_prop_types51.default.elementType
  }),
  /**
   * Start `InputAdornment` for this component.
...
var NativeSelectInput = React61.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime43.jsxs)(React61.Fragment, {
...
var Tab = React65.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React65.isValidElement(iconProp) ? React65.cloneElement(iconProp, {
    className: clsx_default(classes.icon, iconProp.props.className)
  }) : iconProp;
  const handleClick = (event) => {
  ...
  return (0, import_jsx_runtime47.jsxs)(TabRoot, {
    focusRipple: !disableFocusRipple,
    className: clsx_default(classes.root, className),
    ref,
    role: "tab",
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime47.jsxs)(React65.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime47.jsxs)(React65.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
var TabScrollButton = React68.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
  ...
  return (0, import_jsx_runtime50.jsx)(TabScrollButtonRoot, {
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime50.jsx)(StartButtonIcon, {
      ...startButtonIconProps
    }) : (0, import_jsx_runtime50.jsx)(EndButtonIcon, {
      ...endButtonIconProps
    })
  });
});
true ? TabScrollButton.propTypes = {
   ...
   */
  direction: import_prop_types56.default.oneOf(["left", "right"]).isRequired,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   */
  orientation: import_prop_types56.default.oneOf(["horizontal", "vertical"]).isRequired,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   * @default {}
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React69.useRef();
...
var Tabs = React70.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [mounted, setMounted] = React70.useState(false);
  const [indicatorStyle, setIndicatorStyle] = React70.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React70.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React70.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React70.useState(false);
  const [scrollerStyle, setScrollerStyle] = React70.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React70.useRef(null);
  const tabListRef = React70.useRef(null);
  const externalForwardedProps = {
    slots,
    slotProps: {
  ...
  const handleScrollbarSizeChange = React70.useCallback((scrollbarWidth) => {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime52.jsx)(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime52.jsx)(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime52.jsx)(ScrollButtonsSlot, {
  ...
  const indicator = (0, import_jsx_runtime52.jsx)(IndicatorSlot, {
    ...indicatorSlotProps
  });
  let childIndex = 0;
  const children2 = React70.Children.map(childrenProp, (child) => {
  ...
  return (0, import_jsx_runtime52.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime52.jsxs)(ScrollerSlot, {
      ...scrollerSlotProps,
      children: [(0, import_jsx_runtime52.jsx)(ListSlot, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
true ? Tabs.propTypes = {
   ...
   * @default false
   */
  allowScrollButtonsMobile: import_prop_types58.default.bool,
  /**
   ...
   * @default false
   */
  centered: import_prop_types58.default.bool,
  /**
   * The content of the component.
   */
   ...
   * @default 'primary'
   */
  indicatorColor: import_prop_types58.default.oneOfType([import_prop_types58.default.oneOf(["primary", "secondary"]), import_prop_types58.default.string]),
  /**
   ...
   */
  ScrollButtonComponent: import_prop_types58.default.elementType,
  /**
   ...
   * @default 'auto'
   */
  scrollButtons: import_prop_types58.default.oneOf(["auto", false, true]),
  /**
  ...
  slotProps: import_prop_types58.default.shape({
    ...
    indicator: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
    list: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
    root: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
    scrollbar: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
    scrollButtons: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
    scroller: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.object]),
  ...
  slots: import_prop_types58.default.shape({
    ...
    list: import_prop_types58.default.elementType,
    root: import_prop_types58.default.elementType,
    scrollbar: import_prop_types58.default.elementType,
    scrollButtons: import_prop_types58.default.elementType,
    scroller: import_prop_types58.default.elementType,
   ...
   * @default  {}
   */
  TabIndicatorProps: import_prop_types58.default.object,
  /**
   * Props applied to the [`TabScrollButton`](https://mui.com/material-ui/api/tab-scroll-button/) element.
   * @deprecated use the `slotProps.scrollButtons` prop instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](https://mui.com/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   * @default {}
   */
  TabScrollButtonProps: import_prop_types58.default.object,
  /**
   * Determines the color of the `Tab`.
   * @default 'primary'
   */
  textColor: import_prop_types58.default.oneOf(["inherit", "primary", "secondary"]),
  /**
   ...
   * @default 'standard'
   */
  variant: import_prop_types58.default.oneOf(["fullWidth", "scrollable", "standard"]),
  /**
   * If `true`, the scrollbar is visible. It can be useful when displaying
   * a long vertical list of tabs.
   * @default false
   */
  visibleScrollbar: import_prop_types58.default.bool
} : void 0;
...
var TextField = React71.forwardRef(function TextField2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTextField"
  });
...
true ? TextField.propTypes = {
  ...
  slotProps: import_prop_types59.default.shape({
    formHelperText: import_prop_types59.default.oneOfType([import_prop_types59.default.func, import_prop_types59.default.object]),
    htmlInput: import_prop_types59.default.oneOfType([import_prop_types59.default.func, import_prop_types59.default.object]),
    input: import_prop_types59.default.oneOfType([import_prop_types59.default.func, import_prop_types59.default.object]),
    inputLabel: import_prop_types59.default.oneOfType([import_prop_types59.default.func, import_prop_types59.default.object]),
    select: import_prop_types59.default.oneOfType([import_prop_types59.default.func, import_prop_types59.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types59.default.shape({
    formHelperText: import_prop_types59.default.elementType,
    htmlInput: import_prop_types59.default.elementType,
    input: import_prop_types59.default.elementType,
    inputLabel: import_prop_types59.default.elementType,
...
//# sourceMappingURL=chunk-UHNWIMID.js.map
